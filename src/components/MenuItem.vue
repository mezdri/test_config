<template>
  ...
  >
    ...
    <v-list v-show="mostrarMenuAcciones">
      ...
      >
        <v-list-tile-avatar style="min-width: 35px;">
          <v-btn
            small
            icon
            @click="handleItemClick(Accion.cargarArchivo)"
            :disabled="!enabledEditBtn"
          >
            <v-icon small color="#526da5">edit</v-icon>
          </v-btn>
        ...
        <v-list-tile-title
          style="cursor:pointer;font-size:13px;;color:rgba(0,0,0,0.7);"
          @click="handleItemClick(Accion.cargarArchivo)"
          >{{ btnCargarArchivoTexto }}</v-list-tile-title
        >
      </v-list-tile>
      ...
      >
        <v-list-tile-avatar style="min-width: 35px;">
          <v-btn
            small
            icon
            @click="handleItemClick(Accion.EditarApn)"
            :disabled="!enabledDeleteBtn"
          >
            <v-icon small color="#526da5">edit</v-icon>
          </v-btn>
      ...
      >
        <v-list-tile-avatar style="min-width: 35px;">
          <v-btn
            small
            icon
            @click="handleItemClick(Accion.EliminarApn)"
            :disabled="!enabledDeleteBtn"
          >
            <v-icon small color="#526da5">delete</v-icon>
          </v-btn>
        ...
        <v-list-tile-title
          style="cursor:pointer;font-size:13px;;color:rgba(0,0,0,0.7);"
          @click="handleItemClick(Accion.EliminarApn)"
          >Eliminar Apn</v-list-tile-title
        >
      </v-list-tile>
      <!----------------- plan -->
      <v-list-tile
      ...
      >
        <v-list-tile-avatar style="min-width: 35px;">
          <v-btn
            small
            icon
            @click="handleItemClick(Accion.EditarPlan)"
            :disabled="!enabledDeleteBtn"
          >
            <v-icon small color="#526da5">edit</v-icon>
          </v-btn>
        ...
        <v-list-tile-title
          style="cursor:pointer;font-size:13px;;color:rgba(0,0,0,0.7);"
          @click="handleItemClick(Accion.EditarPlan)"
          >Editar Plan</v-list-tile-title
        >
      </v-list-tile>

      <v-list-tile
        style="height:40px;"
        v-if="btnEliminarPlan"
        :disabled="!enabledDeleteBtn"
      >
        <v-list-tile-avatar style="min-width: 35px;">
          <v-btn
            small
            icon
            @click="handleItemClick(Accion.EliminarPlan)"
            :disabled="!enabledDeleteBtn"
          >
            <v-icon small color="#526da5">delete</v-icon>
          </v-btn>
        ...
        <v-list-tile-title
          style="cursor:pointer;font-size:13px;;color:rgba(0,0,0,0.7);"
          @click="handleItemClick(Accion.EliminarPlan)"
          >Eliminar Plan</v-list-tile-title
        >
      </v-list-tile>
      <!-- -------------------------- Fin plan -->
      <!----------------- Apn Crear -->
      ...
      >
        <v-list-tile-avatar style="min-width: 35px;">
          <v-btn
            small
            icon
            @click="handleItemClick(Accion.EditarApnCrear)"
            :disabled="!enabledDeleteBtn"
          >
            <v-icon small color="#526da5">edit</v-icon>
          </v-btn>
      ...
      >
        <v-list-tile-avatar style="min-width: 35px;">
          <v-btn
            small
            icon
            @click="handleItemClick(Accion.EliminarApnCrear)"
            :disabled="!enabledDeleteBtn"
          >
            <v-icon small color="#526da5">delete</v-icon>
          </v-btn>
      ...
      >
        <v-list-tile-avatar style="min-width: 35px;">
          <v-btn
            small
            icon
            @click="handleItemClick(Accion.EditarStockCrear)"
            :disabled="!enabledDeleteBtn"
          >
            <v-icon small color="#526da5">edit</v-icon>
          </v-btn>
        ...
        <v-list-tile-title
          style="cursor:pointer;font-size:13px;;color:rgba(0,0,0,0.7);"
          @click="handleItemClick(Accion.EditarStockCrear)"
          >Editar Stock</v-list-tile-title
        >
      </v-list-tile>

      <v-list-tile
        style="height:40px;"
        v-if="btnEliminarStockCrear"
        :disabled="!enabledDeleteBtn"
      >
        <v-list-tile-avatar style="min-width: 35px;">
          <v-btn
            small
            icon
            @click="handleItemClick(Accion.EliminarStockCrear)"
            :disabled="!enabledDeleteBtn"
          >
            <v-icon small color="#526da5">delete</v-icon>
          </v-btn>
        ...
        <v-list-tile-title
          style="cursor:pointer;font-size:13px;;color:rgba(0,0,0,0.7);"
          @click="handleItemClick(Accion.EliminarStockCrear)"
          >Eliminar Stock</v-list-tile-title
        >
      </v-list-tile>
      <!-- -------------------------- Fin Stock Crear -->
      <v-list-tile
      ...
      >
        <v-list-tile-avatar style="min-width: 35px;">
          <v-btn
            small
            icon
            @click="handleItemClick(Accion.EditarStock)"
            :disabled="!enabledDeleteBtn"
          >
            <v-icon small color="#526da5">edit</v-icon>
          </v-btn>
      ...
      >
        <v-list-tile-avatar style="min-width: 35px;">
          <v-btn
            small
            icon
            @click="handleItemClick(Accion.EliminarStock)"
            :disabled="!enabledDeleteBtn"
          >
            <v-icon small color="#526da5">delete</v-icon>
          </v-btn>
      ...
      <v-list-tile style="height:40px;" v-if="btnExportarCRM">
        <v-list-tile-avatar style="min-width: 35px;">
          <v-btn small icon @click="handleItemClick(Accion.Exportar_A_CRM)">
            <v-icon small color="#526da5">ios_share</v-icon>
          </v-btn>
        </v-list-tile-avatar>
        <v-list-tile-title
          style="cursor:pointer;font-size:13px;;color:rgba(0,0,0,0.7);"
          @click="handleItemClick(Accion.Exportar_A_CRM)"
          >Exportar a CRM</v-list-tile-title
        >
      </v-list-tile>
      ...
      <v-list-tile style="height: 40px" v-if="btnEnviar">
        ...
        <v-list-tile-title
          ...
          >{{ btnEnviarText }}</v-list-tile-title
        >
      </v-list-tile>

      <v-list-tile style="height:40px;" v-if="btnCompartir">
        <v-list-tile-avatar style="min-width: 35px;">
          <v-btn small icon @click="handleItemClick(Accion.compartir)">
            <v-icon small color="#526da5">share</v-icon>
          </v-btn>
        </v-list-tile-avatar>
        <v-list-tile-title
          style="cursor:pointer;font-size:13px;;color:rgba(0,0,0,0.7);"
          @click="handleItemClick(Accion.compartir)"
          >{{ this.btnCompartirTexto }}</v-list-tile-title
        >
      </v-list-tile>
...
export default Vue.extend({
  data: function() {
    return {
      ...
      btnEliminar: true,
      btnEliminarApn: false,
      btnEditarApn: false,
      btnEliminarPlan: false,
      btnEditarPlan: false,
      btnEliminarApnCrear: false,
      btnEditarApnCrear: false,
      btnEliminarStockCrear: false,
      btnEditarStockCrear: false,
      btnEditar: true,
      btnVerDetalle: true,
      ...
      btnAnular: false,
      btnEditarStock: false,
      btnEliminarStock: false,
      btnCargarArchivo: false,
      btnCargarArchivoTexto: 'Cargar Archivo',
      btnCompartir: false,
      btnCompartirTexto: 'Compartir',
    };
  },
  props: {
    usuario: {
  ...
  methods: {
    ...
    chequearPermisos() {
      ...
      if (this.params.codigoAccionesMenuItem.length > 0) {
        ...
        const accionElimnarApnCrear = this.params.usuario.permisosUsuario.find(
          x =>
            x.moduloCodigo === this.params.funcionalidad &&
            x.accionCodigo === CodigoAccion.EliminarApnCrear &&
            x.clienteId === config.getClienteSesion()
        );

        if (
          accionElimnarApnCrear !== undefined &&
          accionElimnarApnCrear !== null
        ) {
          this.btnEliminarApnCrear = true;
        } else {
          this.btnEliminarApnCrear = false;
        }
        ////////////////////////// Editar apn Crear
        if (boolPermisos) {
          this.mostrarMenuAcciones = true;
        ...
        const accionEditarApnCrear = this.params.usuario.permisosUsuario.find(
          x =>
            x.moduloCodigo === this.params.funcionalidad &&
            x.accionCodigo === CodigoAccion.EditarApnCrear &&
            x.clienteId === config.getClienteSesion()
        );

        if (
          accionEditarApnCrear !== undefined &&
          accionEditarApnCrear !== null
        ) {
          this.btnEditarApnCrear = true;
        } else {
          this.btnEditarApnCrear = false;
        }
        ...
        const accionElimnarApn = this.params.usuario.permisosUsuario.find(
          x =>
            x.moduloCodigo === this.params.funcionalidad &&
            x.accionCodigo === CodigoAccion.EliminarApn &&
            x.clienteId === config.getClienteSesion()
        );

        if (accionElimnarApn !== undefined && accionElimnarApn !== null) {
          this.btnEliminarApn = true;
        } else {
          this.btnEliminarApn = false;
        }
        ////////////////////////// Editar apn
        if (boolPermisos) {
          this.mostrarMenuAcciones = true;
        ...
        const accionEditarApn = this.params.usuario.permisosUsuario.find(
          x =>
            x.moduloCodigo === this.params.funcionalidad &&
            x.accionCodigo === CodigoAccion.EditarApn &&
            x.clienteId === config.getClienteSesion()
        );

        if (accionEditarApn !== undefined && accionEditarApn !== null) {
          this.btnEditarApn = true;
        } else {
          this.btnEditarApn = false;
        }
        ...
        const accionElimnarPlan = this.params.usuario.permisosUsuario.find(
          x =>
            x.moduloCodigo === this.params.funcionalidad &&
            x.accionCodigo === CodigoAccion.EliminarPlanCrear &&
            x.clienteId === config.getClienteSesion()
        );

        if (accionElimnarPlan !== undefined && accionElimnarPlan !== null) {
          this.btnEliminarPlan = true;
        } else {
          this.btnEliminarPlan = false;
        }
        ////////////////////////// Editar Plan
        if (boolPermisos) {
          this.mostrarMenuAcciones = true;
        ...
        const accionEditarPlan = this.params.usuario.permisosUsuario.find(
          x =>
            x.moduloCodigo === this.params.funcionalidad &&
            x.accionCodigo === CodigoAccion.EditarPlanCrear &&
            x.clienteId === config.getClienteSesion()
        );

        if (accionEditarPlan !== undefined && accionEditarPlan !== null) {
          this.btnEditarPlan = true;
        } else {
          this.btnEditarPlan = false;
        }
        ...
        const accionElimnarStock = this.params.usuario.permisosUsuario.find(
          x =>
            x.moduloCodigo === this.params.funcionalidad &&
            x.accionCodigo === CodigoAccion.EliminarStock &&
            x.clienteId === config.getClienteSesion()
        );

        if (accionElimnarStock !== undefined && accionElimnarStock !== null) {
          this.btnEliminarStock = true;
        } else {
          this.btnEliminarStock = false;
        }
        ////////////////////////// Editar Stock
        if (boolPermisos) {
          this.mostrarMenuAcciones = true;
        ...
        const accionEditarStock = this.params.usuario.permisosUsuario.find(
          x =>
            x.moduloCodigo === this.params.funcionalidad &&
            x.accionCodigo === CodigoAccion.EditarStock &&
            x.clienteId === config.getClienteSesion()
        );

        if (accionEditarStock !== undefined && accionEditarStock !== null) {
          this.btnEditarStock = true;
        } else {
          this.btnEditarStock = false;
        }
        ...
        const accionElimnarStockCrear = this.params.usuario.permisosUsuario.find(
          x =>
            x.moduloCodigo === this.params.funcionalidad &&
            x.accionCodigo === CodigoAccion.EliminarStockCrear &&
            x.clienteId === config.getClienteSesion()
        );

        if (
          accionElimnarStockCrear !== undefined &&
          accionElimnarStockCrear !== null
        ) {
          this.btnEliminarStockCrear = true;
        } else {
          this.btnEliminarStockCrear = false;
        }
        ////////////////////////// Editar Stock
        if (boolPermisos) {
          this.mostrarMenuAcciones = true;
        ...
        const accionEditarStockCrear = this.params.usuario.permisosUsuario.find(
          x =>
            x.moduloCodigo === this.params.funcionalidad &&
            x.accionCodigo === CodigoAccion.EditarStockCrear &&
            x.clienteId === config.getClienteSesion()
        );

        if (
          accionEditarStockCrear !== undefined &&
          accionEditarStockCrear !== null
        ) {
          this.btnEditarStockCrear = true;
        } else {
          this.btnEditarStockCrear = false;
        }
        ...
        const CargarArchivoAccion = this.params.usuario.permisosUsuario.find(
          x =>
            x.moduloCodigo === this.params.funcionalidad &&
            x.accionCodigo === CodigoAccion.cargarArchivo &&
            x.clienteId === config.getClienteSesion()
        );

        if (CargarArchivoAccion !== undefined && CargarArchivoAccion !== null) {
          this.btnCargarArchivo = true;
          if (this.params.funcionalidad == 147) {
            this.btnCargarArchivoTexto = 'Cargar Excel Series';
          } else {
            this.btnCargarArchivoTexto = 'Cargar Archivo';
          }
        } else {
          this.btnCargarArchivo = false;
        }

        /*    */

        const compartirAccion = this.params.usuario.permisosUsuario.find(
          x =>
            x.moduloCodigo === this.params.funcionalidad &&
            x.accionCodigo === CodigoAccion.compartir &&
            x.clienteId === config.getClienteSesion()
        );

        if (compartirAccion !== undefined && compartirAccion !== null) {
          this.btnCompartir = true;
          if (this.params.funcionalidad == 147) {
            this.btnCompartirTexto = 'Exportar Excel INET';
          } else {
            this.btnCompartirTexto = 'Compartir';
          }
        } else {
        ...
        const exportarCRMAccion = this.params.usuario.permisosUsuario.find(
          x =>
            x.moduloCodigo === this.params.funcionalidad &&
            x.accionCodigo === CodigoAccion.Exportar_A_CRM &&
            x.clienteId === config.getClienteSesion()
        );
        if (exportarCRMAccion !== undefined && exportarCRMAccion !== null) {
          this.btnExportarCRM = true;
        } else {
          this.btnExportarCRM = false;
        }
  ...
  beforeMount() {
    ...
    //Enviar
    if (
      this.params.funcionalidad === Funcionalidades.AlertasVigilanti ||
      this.params.funcionalidad === Funcionalidades.OrdenesCompra
    ) {
      const enviar = this.params.usuario.permisosUsuario.find(
        x =>
          x.moduloCodigo === this.params.funcionalidad &&
      ...
      if (enviar !== undefined && enviar !== null) {
        if (this.params.funcionalidad === Funcionalidades.OrdenesCompra) {
          this.btnEnviarText = 'Ver PDF';
        } else {
          this.btnEnviarText = 'Enviar Por Correo';
        }
        this.btnEnviar = true;
      } else {
        this.btnEnviar = false;
