  ...
  <v-container fluid v-show="mostrarSerie">
    ...
    <div class="gridcard rounded-card">
      ...
      <div class="gridcard rounded-card DispositivosSeriados">
        <AgGridVue :class="'ag-theme-material'" :gridOptions="gridOptions" />
      </div>
      <ModalEdicion
        :tipo="'seriado'"
        :codigo="codigo"
...
export default class DispositivosSeriadosEdicion extends ComponenteBase {
      ...
      if (this.funcionalidad === Funcionalidades.TablasRecepcionEquipos) {
        if (data.action === Accion.Editar) {
          ...
          if (item !== null) {
            ...
            this.editedItem = data.cellRendererParams.data.serienumero;
