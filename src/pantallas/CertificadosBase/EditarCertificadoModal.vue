<template>
  <ModalMantenedor :show="show">
    <CabeceraModalEditar
      :titulo="'Editar Configuración Base: ' + certificadoSeleccionado.nombre"
      :form="
      ...
      :nombreEntidad="
        certificadoSeleccionado ? certificadoSeleccionado.nombre : ''
      "
...
export default class EditarCertificadoModal extends OperacionCrud {
