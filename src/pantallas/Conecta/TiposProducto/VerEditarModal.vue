<template>
  <ModalMantenedor :show="show">
    <CabeceraModal titulo="Editar Producto" @cerrar="handleCerrar">
      <div
        style="
...
export default class VerEditarModal extends Vue {
  ...
  async editar() {
    console.log(
      this.formFields.codigoProducto.value,
      this.formFields.codigoProductoP.value,
      this.formFields.codigoInet.value,
      this.formFields.descripcionCorta.value,
      this.formFields.descripcionLarga.value,
      this.formFields.cuentaIngreso.value,
      this.formFields.cuentaCosto.value,
    ...
    this.producto = this.formFields.producto.value;
    this.plataforma = this.formFields.plataforma.value;
    this.equipo = this.formFields.tipoequipo.value;
    ...
    return fetchReportesSerie(
      {
        ...
        tipoprodclase: this.producto.configid_clase,
        tipoprodplataforma: this.plataforma.configid_producto,
        tipoprodbaja: this.formFields.estado.value,
        tipoprodid: this.formFields.codigoProducto.value,
        tipoeqid: this.equipo.tipoeqid,
        tipoprodnombre_crm: this.formFields.nombrecrm.value,
      },
      'conecta_matriz_producto_comercial/editar_producto'
    )
      .then((data: any) => {
  ...
  mounted() {
    ...
    this.getEquipos();
    this.formFields.nombrecrm.value = this.codigoEquipo.tipoprodnombre_crm;
    this.formFields.codigoProducto.value = this.codigoEquipo.tipoprodid;
    this.formFields.codigoProductoP.value = this.codigoEquipo.tipoprodcod_producto;
    this.formFields.codigoInet.value = this.codigoEquipo.tipoprodcod_inet;
    this.formFields.descripcionCorta.value = this.codigoEquipo.tipoproddesc_corta;
    this.formFields.descripcionLarga.value = this.codigoEquipo.tipoproddesc_larga;
    this.formFields.cuentaIngreso.value = this.codigoEquipo.tipoprodcuenta_ingreso;
    this.formFields.cuentaCosto.value = this.codigoEquipo.tipoprodcuenta_costo;
    this.formFields.plataforma.value = {
      producto: this.codigoEquipo.producto,
      configid_producto: this.codigoEquipo.tipoprodplataforma,
    };
    this.formFields.producto.value = {
      configvalor_clase: this.codigoEquipo.clase,
      configid_clase: this.codigoEquipo.tipoprodclase,
    };
    this.formFields.tipoequipo.value = {
      tipoeqname: this.codigoEquipo.tipoeqname,
      tipoeqid: this.codigoEquipo.tipoeqid,
    };

    this.id_equipo = this.codigoEquipo.tipoeqid;

    if (this.codigoEquipo.tipoprodestado == 'f') {
      this.formFields.estado.value = {
        text: 'Vigente',
        value: false,
      };
