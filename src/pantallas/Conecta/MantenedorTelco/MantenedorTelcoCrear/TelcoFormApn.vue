...
export default class TelcoFormApn extends ComponenteBase {
  readonly funcionalidad: Funcionalidades =
    Funcionalidades.MantenedorTelcoCrearApn;
  ...
  accionEditarApnCrear: PermisoAccion = {
    accionCodigo: 101,
    visible: false,
  };

  accionEliminarApnCrear: PermisoAccion = {
    accionCodigo: 100,
    visible: false,
  };
  ...
  accionesTotales: PermisoAccion[] = [
    ...
    this.accionEditarApnCrear,
    this.accionEliminarApnCrear,
  ];
  constructor() {
    super();
    actionsEvent.onEditarApnCrear(this.handleVerEditarClickApn);
    actionsEvent.onElminarApnCrear(this.handleElminarApn);
  }
