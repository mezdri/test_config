...
export default class TelcoFormPlanes extends ComponenteBase {
  readonly funcionalidad: Funcionalidades =
    Funcionalidades.MantenedorTelcoCrearPlan;
  ...
  async getplan() {
    let self = this;
    console.log(this.telcoid_crear);
  ...
  accionEditarPlanCrear: PermisoAccion = {
    accionCodigo: 105,
    visible: false,
  };

  accionEliminarPlanCrear: PermisoAccion = {
    accionCodigo: 104,
    visible: false,
  };
  ...
  accionesTotales: PermisoAccion[] = [
    ...
    this.accionEditarPlanCrear,
    this.accionEliminarPlanCrear,
  ];
  constructor() {
    super();
    actionsEvent.onEditarPlan(this.handleVerEditarClickPlan);
    actionsEvent.onElminarPlan(this.handleElminarPlan);
  }
  tipo_sim: any = {};
  ...
  handleElminarPlan(params: ICellRendererParams) {
    ...
    this.telcoidEliminar = this.telcoid_crear;
