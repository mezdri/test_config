<template>
  <ModalMantenedor :show="show">
    <CabeceraModal titulo="Crear Tipo de Dispositivo" @cerrar="handleCerrar">
      ...
      <v-stepper-items class="cardnew">
        ...
        >
          <TipoDispositivoForm
            ...
            test-id="CrearTipoDispositivoModal"
          />
        </v-stepper-content>
      </v-stepper-items>
    </v-stepper>
    ...
    <Confirmation
      ...
      :titulo="
        $t('mensajes.crud.crear.titulo', { entidad: 'Tipo de Dispositivo' })
      "
...
import { crearTipoDispositivo } from '@/pantallas/TipoDispositivo/crearTipoDispositivo';
import { LoadingService } from '@/services/loadingService';
import { Snotify } from '@/snotify/Snotify';
import { Validator } from 'vee-validate/types/vee-validate';
import Confirmation from '@/components/Confirmation.vue';

type CrearTipoDispositivoFormState = {
...
export default class CrearTipoDispositivoModal extends Vue {
  ...
  form: CrearTipoDispositivoFormState = {
    entity: null,
    validator: null,
    isDirty: null,
  };
  ...
  async confirmCallback(val: boolean) {
    ...
    if (val) {
      ...
      return crearTipoDispositivo(this.form.entity)
        .then(() =>
        ...
        .catch(() =>
          this.$snotify.error(
            `Ha ocurrido un error al intentar crear el tipo de dispositivo.`,
            { timeout: 3000 }
          )
        )
        .finally(() => {
