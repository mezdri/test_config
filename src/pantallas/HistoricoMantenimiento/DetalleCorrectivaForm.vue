...
import { fetchActividades } from '@/pantallas/Correctivas/Data/fetchActividades';
import { ActividadesCorrectivas } from '@/pantallas/Correctivas/Data/Correctiva';
...
export default class DetalleCorrectivaForm extends Vue {
